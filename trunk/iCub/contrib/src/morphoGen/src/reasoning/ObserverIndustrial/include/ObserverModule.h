...
class ObserverModule:public yarp::os::RFModule {
    ...
    /*  */
    ObserverThread *rThread, *tThread;             // pointer to a new thread to be created and started in configure() and stopped in close()
	darwin::observer::EffectorThread* _effectorThread;
	darwin::observer::AffordanceAccess* _affordanceAccess;
	darwin::observer::AttentionAccess* _attentionAccess;
	darwin::observer::WorkspaceCalculations* _workspace;
