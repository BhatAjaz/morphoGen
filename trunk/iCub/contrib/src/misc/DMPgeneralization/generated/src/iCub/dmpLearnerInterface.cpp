  ...
  while (!reader.isError()) {    // TODO: use quick lookup, this is just a test
    ...
    if (tag == "train_ids") {
      std::vector<int32_t>  trainInputIds;
      {
        ...
        {
          if (!reader.readI32(trainInputIds[_i5])) return false;
        }
        reader.readListEnd();
      }
      bool _return;
    ...
    if (tag == "train_action") {
      std::string actionName;
      if (!reader.readString(actionName)) return false;
      bool _return;
    ...
    if (tag == "set_num_basis_functions") {
      int32_t N;
      if (!reader.readI32(N)) return false;
    ...
    if (tag == "set_alphax") {
      double alphax;
      if (!reader.readDouble(alphax)) return false;
      set_alphax(alphax);
      yarp::os::idl::WireWriter writer(reader);
      if (!writer.isNull()) {
        if (!writer.writeListHeader(0)) return false;
    ...
    if (tag == "set_alphaz") {
      double alphaz;
      if (!reader.readDouble(alphaz)) return false;
      set_alphaz(alphaz);
      yarp::os::idl::WireWriter writer(reader);
      if (!writer.isNull()) {
        if (!writer.writeListHeader(0)) return false;
    ...
    if (tag == "set_betaz") {
      double betaz;
      if (!reader.readDouble(betaz)) return false;
      set_betaz(betaz);
      yarp::os::idl::WireWriter writer(reader);
      if (!writer.isNull()) {
        if (!writer.writeListHeader(0)) return false;
