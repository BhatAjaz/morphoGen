...
/**********************************************************/
Bottle Manager::executeBlobRecog(string objName)
{
    Bottle loc;
    loc.clear();
    fprintf(stdout, "\n\n\nexecuteBlobRecog****************************************************************************\n\n" );
...
/**********************************************************/
bool Manager::executePCLGrasp( string objName )
{
    fprintf(stdout, "\n\n\nexecutePCLGrasp****************************************************************************\n\n" );
...
int Manager::executeToolSearchOnLoc( string objName )
{
    ...
    if (valid)
    {
        ...
        for (int x=0; x < blobs.size(); x++)
        {
            if ( x!=objIndex)
            {
                ...
                {
                    toolLenght=blobsDetails[x].lenght;
                    smallIndex = x;
                }
            }
        }
...
/**********************************************************/
int Manager::executeToolAttach(Vector tool)
{
...
/**********************************************************/
Bottle Manager::executeKarmaOptimize(Vector tool, string name)
{
...
/**********************************************************/
bool Manager::executeSpeech (string speech)
{
    Bottle cmdIol;
    Bottle replyIol;
    cmdIol.clear(), replyIol.clear();
