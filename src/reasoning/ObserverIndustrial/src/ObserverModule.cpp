...
#include "AffordanceAccessImpl.h"
#include "AttentionAccessImpl.h"
#include "ObserverThread.h"
#include "WorkspaceCalculationsImpl.h"

using namespace yarp::os;
using namespace yarp::sig;
using namespace std;
using namespace darwin::observer;
...
bool ObserverModule::close() {
	...
	_affordanceAccess->stop();
	_attentionAccess->stop();
	_effectorThread->stop();
    rThread->stop();
    return true;
}
