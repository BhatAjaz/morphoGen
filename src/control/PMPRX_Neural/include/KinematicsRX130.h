...
namespace LibRoboMove
{
	...
	///
	class KinematicsRX130 : public Kinematics
	{
	

	private:

    double mShoulderHeight;
      ...
      mShoulderHeight = 550;
        ...
        */
			...
			translations.push_back(TranslationMatrix(0, -mShoulderHeight, 0));
	...
	public:
		...
		ROBOMOVE_API KinematicsRX130(int type = RX130B, float flangeToTCP_x = 0, float flangeToTCP_y = 0, float flangeToTCP_z = 0)
		{
			matType m;
		...
		ROBOMOVE_API KinematicsRX130(int type, matType flangeToTcp, matType tcpToFlange)
		{
			Init(type, flangeToTcp, tcpToFlange);
		}

		/// @brief Destructor
		ROBOMOVE_API ~KinematicsRX130(void)
		{
		}
      ...
      */
      ...
      // the points q, r, s, and t are coplanar (n is the normal vector of this plane, plane goes through origin)
      vecType v(q[0], q[1], 0);
